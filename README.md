...
║░║░║░░░╚═1 [gzip example : binary <-> gz, txt <-> gz](10_Python_Document/02_Library_Reference/01_Data_Compression_and_Archiving/01_gzip_example.ipynb)  
║░║░╚═2 [Text Processing Services](https://docs.python.org/3/library/text.html)  
║░║░░░╚═1 [Regular expression operations](https://docs.python.org/3/library/re.html)  
║░║░░░░░╚═1 [re example : compile method, pattern obj, search method, match obj](10_Python_Document/02_Library_Reference/02_Text_Processing_Services/01_re_example.ipynb)  
...
░░╠═8 [change_A_to_B](99_Utility/change_A_to_B.txt)  
░░╠═9 [contents](99_Utility/contents.txt)  
░░╠═10 [jupyter notebook](99_Utility/jn_jupyter_notebook.sh)  
░░╠═11 [sync and delete folder from folder](99_Utility/sync_and_delete_a_from_b.py)  
░░╚═12 [sync file](99_Utility/sync_file.py)  
( ║░╠ ═ ╚ ░)  
