...
║░║░╠═2 [linux brew install python3](01_Python_Env_and_ETC/02_brew/02_linux_brew_install_python3.md)  
║░║░╠═3 [linux brew python3 venv : create virtual env](01_Python_Env_and_ETC/02_brew/03_linux_brew_python3_venv_env.md)  
║░║░╠═4 [mac brew install autoenv : activate/deactivate pyenv-virtualenv's env](01_Python_Env_and_ETC/02_brew/04_mac_brew_install_autoenv.md)  
║░║░╠═5 [mac brew install pyenv : python env](01_Python_Env_and_ETC/02_brew/05_mac_brew_install_pyenv.md)  
║░║░╠═6 [mac brew install pyenv-virtualenv : python virtual env](01_Python_Env_and_ETC/02_brew/06_mac_brew_install_pyenv-virtualenv.md)  
║░║░╚═7 [mac brew python3.7 : debugging error with multiprocessing](01_Python_Env_and_ETC/02_brew/07_mac_brew_python3.7_venv_multiprocessing_error.md)  
║░╠═3 conda  
...
░░╠═7 [reNumberFolder](99_Utility/reNumberFolder.py)  
░░╠═8 [source activate](99_Utility/sa_source_activate.sh)  
░░╠═9 [sync and delete folder from folder](99_Utility/sync_and_delete_a_from_b.py)  
░░╚═10 [sync file](99_Utility/sync_file.py)  
( ║░╠ ═ ╚ ░)  
