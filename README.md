...
║░║░╠═1 [Concurrent Execution](https://docs.python.org/3/library/concurrency.html)  
║░║░║░╠═1 [subprocess](https://docs.python.org/3/library/subprocess.html)  
║░║░║░║░╚═1 [subprocess example : echo, ls](10_Python_Document/03_Library_Reference/01_Concurrent_Execution/01_subprocess/01_subprocess_example.ipynb)  
║░║░║░╚═2 [queue](https://docs.python.org/3/library/queue.html)  
║░║░║░░░╚═1 [queue example : put, get, qsize](10_Python_Document/03_Library_Reference/01_Concurrent_Execution/02_queue/01_queue_example.ipynb)  
║░║░╠═2 [Data Compresssion and Archiving](https://docs.python.org/3/library/archiving.html)  
║░║░║░╚═1 [gzip](https://docs.python.org/3/library/gzip.html)  
║░║░║░░░╚═1 [gzip example : binary <-> gz, txt <-> gz](10_Python_Document/03_Library_Reference/02_Data_Compression_and_Archiving/01_gzip_example.ipynb)  
║░║░╠═3 [Data Types](https://docs.python.org/3/library/datatypes.html)  
║░║░║░╚═1 [calendar](https://docs.python.org/3/library/calendar.html)  
║░║░║░░░╚═1 [calendar.monthrange](https://docs.python.org/3/library/calendar.html#calendar.monthrange) : example [get weekdays of first day of month, last day of month](10_Python_Document/03_Library_Reference/03_Data_Types/01_calendar.monthrange.ipynb)  
║░║░╠═4 [Functional Programming Modules](https://docs.python.org/3/library/functional.html)  
...
║░║░╚═5 [Text Processing Services](https://docs.python.org/3/library/text.html)  
║░║░░░╚═1 [Regular expression operations](https://docs.python.org/3/library/re.html)  
║░║░░░░░╚═1 [re example : compile method, pattern obj, search method, match obj](10_Python_Document/03_Library_Reference/04_Text_Processing_Services/01_re_example.ipynb)  
